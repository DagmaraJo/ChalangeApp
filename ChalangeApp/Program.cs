...
Console.WriteLine($"  Min_{statistics1.Min:N2}/ Average_{statistics1.Average:N2}/ Max_{statistics1.Max:N2} Foreach");
Console.WriteLine($"  Min_{statistics2.Min:N2}/ Average_{statistics2.Average:N2}/ Max_{statistics2.Max:N2} For");
Console.WriteLine($"  Min_{statistics3.Min:N2}/ Average_{statistics3.Average:N2}/ Max_{statistics3.Max:N2} DoWhile");
Console.WriteLine($"  Min_{statistics4.Min:N2}/ Average_{statistics4.Average:N2}/ Max_{statistics4.Max:N2} While");